...
export default function EmployeesFilters({
    ...
    const hasActiveFilters =
        onlyAdmin || (!!fullText?.trim?.()) || !!position || !!status ||
        !!department;

    const prevHasActiveFilters = useRef<boolean>(hasActiveFilters);
            ...
            <div className="filters-group">
                <div className="filter-column">
                    <label
                        htmlFor="only-admin"
                        style={{ display: "flex" }}
                        className={"filter-column-checkbox__label"}
                    >
                        <img
                            src={"/icons/Star.svg"}
                            width={16}
                    ...
                    <input
                        ...
                        type="checkbox"
                        checked={onlyAdmin}
                        onChange={(e) => onOnlyAdminChange(e.target.checked)}
                    />
                </div>
                ...
                <div className="filter-column">
                    ...
                    <input
                        ...
                        type="text"
                        value={fullText}
                        onChange={(e) => fullTextChange(e.target.value)}
                        placeholder="поиск"
                    />
                </div>
