...
export function WorkerStatusSelector({status, onChange, disabled}: Props){
  return (
  <select
    id="status"
...
export default function WorkerStatusSelectorRowInfo(props: Props) {
  return (
    <RowInfo label="текущий статус">
      <WorkerStatusSelector {...props} />
    </RowInfo>
  )
}
